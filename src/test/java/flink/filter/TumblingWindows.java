    ...
    public static void main(String[] args) throws Exception {
        ...
        SingleOutputStreamOperator<Tuple4<Long, Integer, Double, Double>> reducedStream =
                Source.assignTimestampsAndWatermarks(
                        ...
                        }).flatMap(new Tokenizer()).keyBy(1).window(TumblingEventTimeWindows.of(Time.seconds(100)))
        ...
        System.out.println(
                streamN + "条记录文件100s长度滚动窗口，" + env.getParallelism() + "线程" + sink + "总耗时" + (endTime - startTime));
