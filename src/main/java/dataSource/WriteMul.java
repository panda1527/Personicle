                    ...
                    for (int i = 0; i < len; i++) {
                        if (!orders[i].done) {
                            if (time < orders[i].start_time1) {
                                ...
                                lon = cities[orders[i].start_city].lon +
                                        (cities[orders[i].first_transfer].lon - cities[orders[i].start_city].lon) * (
                                                time - orders[i].start_time1) / (orders[i].arrive_time1
                                                - orders[i].start_time1);
                                lat = cities[orders[i].start_city].lat +
                                        (cities[orders[i].first_transfer].lat - cities[orders[i].start_city].lat) * (
                                                time - orders[i].start_time1) / (orders[i].arrive_time1
                                                - orders[i].start_time1);
                                Buff.write((time + " " + i + " " + lon + " " + lat + "\r\n").getBytes());
                                ...
                                lon = cities[orders[i].first_transfer].lon +
                                        (cities[orders[i].last_transfer].lon - cities[orders[i].first_transfer].lon) * (
                                                time - orders[i].start_time2) / (orders[i].arrive_time2
                                                - orders[i].start_time2);
                                lat = cities[orders[i].first_transfer].lat +
                                        (cities[orders[i].last_transfer].lat - cities[orders[i].first_transfer].lat) * (
                                                time - orders[i].start_time2) / (orders[i].arrive_time2
                                                - orders[i].start_time2);
                                Buff.write((time + " " + i + " " + lon + " " + lat + "\r\n").getBytes());
                                ...
                                lon = cities[orders[i].last_transfer].lon +
                                        (cities[orders[i].end_city].lon - cities[orders[i].last_transfer].lon) * (time
                                                - orders[i].start_time3) / (orders[i].arrive_time3
                                                - orders[i].start_time3);
                                lat = cities[orders[i].last_transfer].lat +
