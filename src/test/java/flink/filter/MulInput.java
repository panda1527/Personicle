...
public class MulInput {
    ...
    public static void main(String[] args) throws Exception {
        ...
        DataStream<String> stream = env.readTextFile("./streams/0.txt");
        for (int i = 1; i < 10; i++) {
            streams.add(env.readTextFile("./streams/" + i + ".txt"));
        ...
        counts.writeAsText("./result", FileSystem.WriteMode.OVERWRITE);
    ...
    public static final class Tokenizer implements FlatMapFunction<String, Tuple2<Integer, Integer>> {
        ...
        @Override public void flatMap(String value, Collector<Tuple2<Integer, Integer>> out) {
